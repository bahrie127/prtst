...
@Entity
@Table(name = "nilai_mc")
public class NilaiMc implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "nilai_mc_id")
    private Long id;
    @ManyToOne
    ...
    public boolean equals(Object obj) {
        ...
        final NilaiMc other = (NilaiMc) obj;
    ...
    public int hashCode() {
        ...
        hash = 59 * hash + (this.pertemuanPraktikum != null ? this.pertemuanPraktikum.hashCode() : 0);
        hash = 59 * hash + (this.nilai != null ? this.nilai.hashCode() : 0);
        hash = 59 * hash + (this.statusNilai != null ? this.statusNilai.hashCode() : 0);
        return hash;
    }
